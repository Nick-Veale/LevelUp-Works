...
function Nav() {
    ...
    const [modalinputs, setModalInputs] = React.useState(<SignUpPuts />);
    const [signStyle, setSignStyle] = React.useState({borderBottom: '4px solid #f91c85'});
    const [logStyle, setLogStyle] = React.useState({});
