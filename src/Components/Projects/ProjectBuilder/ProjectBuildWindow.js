      ...
      if (user.isTeacher) {
        return (
          <>
            ...
            <ul className="submittedProjects">
              <li className="projectCard">
                ...
                <div className="projectCardMiddle">
                  ...
                  <img
                    id="myImg"
                    style={{ width: "200x", height: "100px", margin: "20px" }}
                    src={scratchScreenshot}
                    alt="scratchScreenshotModal"
                  ></img>
                  <br />
                  <button
                    onClick={() => setIsOpen(true)}
                    className="enlargePhoto"
                  >
                    &#128269; ENLARGE PHOTO
                  </button>

                  <Modal open={isOpen} onClose={() => setIsOpen(false)}>
                    <img src={scratchScreenshot} alt=""></img>
                  </Modal>
                </div>
