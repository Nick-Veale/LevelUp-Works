    ...
    return (
      <div className={classes.root}>
        ...
        <AppBar position="fixed" className={clsx(classes.appBar)}>
          <Toolbar
            style={{ backgroundColor: "white", boxShadow: "0px 0px 0px black" }}
          >
        ...
        >
          ...
          <div style={showLowerIcons()} className="sideBarLowMainDivOpen">
            ...
            <div
              className="sideBarLowSingleDivOpen"
          ...
          <div style={hideLowerIcons()} className="sideBarLowMainDivOpen">
            ...
            <div
              className="sideBarLowSingleDivClosed"
              onClick={() => handleLogOut()}
            >
              <icon>
                <ExitToApp id="sideBarLowIcon" />
